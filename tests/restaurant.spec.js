...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(createMenu(objetoRetornado).fetchMenu(), objetoRetornado);
    ...
    const objetoRetornado4 = createMenu({food: {coxinha: 4.00, agua: 4.50, sopa: 15.00, sashimi : 45.00}});
    ...
    const objetoRetornado5 = createMenu({food: {coxinha: 4.00, agua: 4.50, sopa: 15.00, sashimi : 45.00}});
    ...
    const objetoRetornado6 = createMenu({food: {coxinha: 4.00, agua: 4.50, sopa: 15.00, sashimi : 45.00}});
    objetoRetornado6.order('coxinha');
    objetoRetornado6.order('agua');
    objetoRetornado6.order('coxinha');
    assert.strictEqual(objetoRetornado6.pay(), parseFloat(13.75).toFixed(2));
